...
const ThemesSection = styled(SectionWrapper)`
  ...
  &::before {
    ...
    bottom: 0;
    background: 
      radial-gradient(circle at 15% 25%, rgba(26, 71, 42, 0.03) 0%, transparent 50%),
      radial-gradient(circle at 85% 75%, rgba(212, 175, 55, 0.02) 0%, transparent 50%);
    pointer-events: none;
  }
`;
